        ...
        return (
               <View>
                   ...
                   <View style={styles.box1}>
                       <Text style={{ fontSize: 16, alignSelf:"center" }}>Positif</Text>
                       <Text style={styles.text}>{this.state.positive}</Text>
                   </View>
                   <View style={styles.box2}>
                        <Text style={{ fontSize: 16, alignSelf:"center" }}>Sembuh</Text>
                       <Text style={styles.text}>{this.state.sembuh}</Text>
                   </View>
                   <View style={styles.box3}>
                        <Text style={{ fontSize: 16, alignSelf:"center" }}>Meninggal</Text>
                        <Text style={styles.text}>{this.state.meninggal}</Text>
                   </View>
                   <View style={styles.box4}>
                        <Text style={{ fontSize: 16, alignSelf:"center" }}>Perawatan</Text>
